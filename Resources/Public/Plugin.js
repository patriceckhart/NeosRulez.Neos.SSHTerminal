...
var _Row = __webpack_require__(/*! ./components/Row */ "./src/components/Row.js");

var _Row2 = _interopRequireDefault(_Row);

var _Response = __webpack_require__(/*! ./components/Response */ "./src/components/Response.js");

var _Response2 = _interopRequireDefault(_Response);

var _Splash = __webpack_require__(/*! ./components/Splash */ "./src/components/Splash.js");
...
var Terminal = function (_React$Component) {
    ...
    function Terminal(props) {
        ...
        _this.updateResponose = _this.updateResponose.bind(_this);
        _this.focusCommandInput = _this.focusCommandInput.bind(_this);
        return _this;
    }

    _createClass(Terminal, [{
        key: 'updateResponose',
        value: function updateResponose(result) {
            this.setState({
                response: [].concat(_toConsumableArray(this.state.response), [result.result])
            });
        }
    }, {
        key: 'setResponse',
        value: function setResponse(response) {
            ...
            response.then(function (result) {
                _this2.updateResponose(result);
            });
        }
    }, {
        key: 'focusCommandInput',
        value: function focusCommandInput() {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { id: 'sshTerminal', className: _styles2.default.sshTerminal, onClick: this.focusCommandInput },
                _react2.default.createElement(
                    'ul',
                    { className: _styles2.default.interfaceUl },
                    this.props.splashScreen && _react2.default.createElement(_Splash2.default, { safeMode: this.props.safeMode }),
                    _react2.default.createElement(_Row2.default, { autoFocus: true, fakeUser: this.props.fakeUser, setResponse: function setResponse(p) {
                            return _this3.setResponse(p);
                        } }),
                    this.state.response && _react2.default.createElement(
                        'div',
                        null,
                        this.state.response.map(function (responseItem) {
                            return _react2.default.createElement(
                                'div',
                                null,
                                _react2.default.createElement(
                                    'div',
                                    null,
                                    responseItem !== '' && _react2.default.createElement(_Response2.default, { response: responseItem }),
                                    _react2.default.createElement(_Row2.default, { autoFocus: true, fakeUser: _this3.props.fakeUser, setResponse: function setResponse(p) {
                                            return _this3.setResponse(p);
                                        } })
                                )
                            );
    ...
    _createClass(Response, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: _styles2.default.response },
                    _react2.default.createElement('span', { dangerouslySetInnerHTML: { __html: this.props.response } })
                )
            );
        }
    }]);
...
var _base = __webpack_require__(/*! base-64 */ "./node_modules/base-64/base64.js");
...
var Row = function (_React$Component) {
    ...
    function Row(props) {
        ...
        _this.fetchCommand = _this.fetchCommand.bind(_this);
        return _this;
    }

    _createClass(Row, [{
        key: 'fetchCommand',
        value: function fetchCommand(value) {
            var _this2 = this;
            ...
            fetch('/sshterminal/command/send?command=' + (0, _base.encode)(value), requestOptions).then(function (response) {
                return _this2.props.setResponse(response.json());
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.state.command && _react2.default.createElement(
                        'div',
                        { className: _styles2.default.freezedInput },
                        this.state.command
                    ),
                    !this.state.command && _react2.default.createElement('input', { id: 'commandInput', type: 'text', autoFocus: !!this.props.autoFocus, onKeyDown: this.handleKeyDown, defaultValue: '' })
                )
            );
        }
    }]);
    ...
    _createClass(Splash, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: _styles2.default.splash },
                    _react2.default.createElement(
                        'svg',
                        { style: { width: '40px' }, xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 512 512' },
                        _react2.default.createElement('path', { d: 'M415.44 512h-95.11L212.12 357.46v91.1L125.69 512H28V29.82L68.47 0h108.05l123.74 176.13V63.45L386.69 0h97.69v461.5zM38.77 35.27V496l72-52.88V194l215.5 307.64h84.79l52.35-38.17h-78.27L69 13zm82.54 466.61l80-58.78v-101l-79.76-114.4v220.94L49 501.89h72.34zM80.63 10.77l310.6 442.57h82.37V10.77h-79.75v317.56L170.91 10.77zM311 191.65l72 102.81V15.93l-72 53v122.72z' })
                    ),
                    _react2.default.createElement(
                        'span',
                        null,
                        'Neos CMS SSH Terminal',
                        !this.props.safeMode && _react2.default.createElement(
                            'small',
                            { style: { display: 'block' } },
                            '\u26A0\uFE0F Safe-Mode is disabled. Use with caution!'
                        )
                    )
                )
            );
...
var _Terminal = __webpack_require__(/*! ./Terminal */ "./src/Terminal.js");
...
(0, _neosUiExtensibility2.default)('NeosRulez.Neos.SSHTerminal:Terminal', {}, function (globalRegistry, _ref) {
...
var SSHTerminal = function SSHTerminal(settings) {
    return function (_PureComponent) {
        _inherits(sshTerminal, _PureComponent);

        function sshTerminal(props) {
            _classCallCheck(this, sshTerminal);

            var _this = _possibleConstructorReturn(this, (sshTerminal.__proto__ || Object.getPrototypeOf(sshTerminal)).call(this, props));
        ...
        _createClass(sshTerminal, [{
            ...
            value: function render() {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: _styles2.default.terminalButton },
                        _react2.default.createElement(
                            'svg',
                            { style: { width: '14px', marginRight: '0.8rem' }, xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 640 512' },
                            _react2.default.createElement('path', { d: 'M257.981 272.971L63.638 467.314c-9.373 9.373-24.569 9.373-33.941 0L7.029 444.647c-9.357-9.357-9.375-24.522-.04-33.901L161.011 256 6.99 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L257.981 239.03c9.373 9.372 9.373 24.568 0 33.941zM640 456v-32c0-13.255-10.745-24-24-24H312c-13.255 0-24 10.745-24 24v32c0 13.255 10.745 24 24 24h304c13.255 0 24-10.745 24-24z' })
                        ),
                        'SSH Terminal'
                    ),
                    _react2.default.createElement(
                        'button',
                        { type: 'button', className: _styles2.default.terminalButtonToggler, onClick: this.handleClick },
                    ...
                    this.state.isToggleOn && _react2.default.createElement(_Terminal2.default, { fakeUser: settings.fakeUser, splashScreen: settings.splashScreen, safeMode: settings.safeMode })
                );
            }
        }]);
...
module.exports = {"terminalButton":"styles__terminalButton___1pKMX","terminalButtonToggler":"styles__terminalButtonToggler___1SWo7","sshTerminal":"styles__sshTerminal___1mbwE","interfaceUl":"styles__interfaceUl___3vwD1","inputWrapper":"styles__inputWrapper___3H5RF","freezedInput":"styles__freezedInput___2vpmL","response":"styles__response___1uJUi","splash":"styles__splash___2dihV"};
